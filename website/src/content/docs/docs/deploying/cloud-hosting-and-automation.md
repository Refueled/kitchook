...
The [complete workflow template](https://github.com/Refueled/kitchook/blob/main/docs/github-actions.md) builds and uploads the static artifact; deployment is a separate step for your chosen host, such as Cloudflare Pages, S3 and CloudFront, or your own static server.
...
Follow the [complete S3 and CloudFront guide](https://github.com/Refueled/kitchook/blob/main/docs/deploying.md#s3-and-cloudfront) for the function, bucket policy, cache controls, upload order, and invalidation commands.
