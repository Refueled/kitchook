...
> **Status:** Archived — superseded architecture baseline  
> **Last reviewed:** 2026-08-24  
> **Primary audience:** Project owner + coding/automation agents  
> **Purpose:** Preserve the original architecture, content model, deployment strategy, implementation phases, and guardrails proposed for a self-hosted cookbook whose long-term source of truth is plain Markdown in Git.
>
> **Archive note:** This predates implementation. See the [completed personal-instance plan](2026-08-30-personal-instance-v1.md) for the verified result and [`PROJECT_PLAN.md`](../../PROJECT_PLAN.md) for current work.
